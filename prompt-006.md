...
Compute the current Yes chance from aggregate positions for this market: yes_total = sum(yes_shares_cents), no_total = sum(no_shares_cents), yes_chance = yes_total / (yes_total + no_total).
